...
if __name__ == '__main__':
    ...
    joined_data = np.load("joined_data_long_reduced_%d_%d.npy" % (WINDOW_LENGTH, NAVDATA_OFFSET_MILIS))
    new_navdata = np.load("new_navdata_long_reduced_%d_%d.npy" % (WINDOW_LENGTH, NAVDATA_OFFSET_MILIS))
